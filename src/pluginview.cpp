...
void KateAiView::ensureUiCreated()
{
    ...
    // Parent only. Kate's tool view already has a layout; adding the same
    // widget to that layout makes Qt walk/remove children and was crashing
    // in QLayout::removeWidgetRecursively on startup (Asahi / KF 6.30).
